    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="C:\Users\Nikhil\Downloads\IMG_20191031_193410~2_1" alt="Image"/></a></div>
          <div class="h2 title">param Bhatt</div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! I am param Bhatt. Web Developer, Graphic Designer and Photographer.</p>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">https://param4creation.github.io/param.io/</div>
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">3, karnavati society, maninagar, amdavad</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
              <div class="col-sm-8">English,gujratiand a sort of tamil</div>
            </div>
          </div>
        </div>
      </div>
